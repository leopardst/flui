...
StackFit flStringToStackFit(String stackFit) {
  switch (stackFit) {
    ...
    case FLDyStackFitType.expand:
      return StackFit.expand;
    case FLDyStackFitType.passthrough:
...
TextWidthBasis flStringToTextWidthBasis(String textWidthBasis) {
  switch (textWidthBasis) {
    ...
    case FLDyTextWidthBasisType.longestLine:
...
TextOverflow flStringToTextOverflow(String textOverflow) {
  switch (textOverflow) {
    ...
    case FLDyTextOverflowType.fade:
      return TextOverflow.fade;
    case FLDyTextOverflowType.ellipsis:
      return TextOverflow.ellipsis;
    case FLDyTextOverflowType.visible:
...
TextDirection flStringToTextDirection(String textDirection) {
  switch (textDirection) {
    ...
    case FLDyTextDirectionType.ltr:
...
TextAlign flStringToTextAlign(String textAlign) {
  switch (textAlign) {
    ...
    case FLDyTextAlignType.right:
      return TextAlign.right;
    case FLDyTextAlignType.center:
      return TextAlign.center;
    case FLDyTextAlignType.justify:
      return TextAlign.justify;
    case FLDyTextAlignType.start:
      return TextAlign.start;
    case FLDyTextAlignType.end:
...
TextDecorationStyle flStringToTextDecorationStyle(String decorationStyle) {
  switch (decorationStyle) {
    ...
    case FLDyTextDecorationStyleType.double:
      return TextDecorationStyle.double;
    case FLDyTextDecorationStyleType.dotted:
      return TextDecorationStyle.dotted;
    case FLDyTextDecorationStyleType.dashed:
      return TextDecorationStyle.dashed;
    case FLDyTextDecorationStyleType.wavy:
...
TextDecoration flStringToTextDecoration(String decoration) {
  switch (decoration) {
    ...
    case FLDyTextDecorationType.underline:
      return TextDecoration.underline;
    case FLDyTextDecorationType.overline:
      return TextDecoration.overline;
    case FLDyTextDecorationType.lineThrough:
...
TextBaseline flStringToTextBaseline(String textBaseline) {
  switch (textBaseline) {
    ...
    case FLDyTextBaselineType.ideographic:
...
BoxFit flStringToBoxFit(String fit) {
  ...
  switch (fit) {
    case FLDyBoxFitType.fill:
      boxFit = BoxFit.fill;
      break;
    case FLDyBoxFitType.contain:
      boxFit = BoxFit.contain;
      break;
    case FLDyBoxFitType.cover:
      boxFit = BoxFit.cover;
      break;
    case FLDyBoxFitType.fitWidth:
      boxFit = BoxFit.fitWidth;
      break;
    case FLDyBoxFitType.fitHeight:
      boxFit = BoxFit.fitHeight;
      break;
    case FLDyBoxFitType.none:
      boxFit = BoxFit.none;
      break;
    case FLDyBoxFitType.scaleDown:
...
ImageRepeat flStringToImageRepeat(String imageRepeat) {
  ...
  switch (imageRepeat) {
    case FLDyImageRepeatType.noRepeat:
      ...
      break;
    case FLDyImageRepeatType.repeat:
      ir = ImageRepeat.repeat;
      break;
    case FLDyImageRepeatType.repeatX:
      ir = ImageRepeat.repeatX;
      break;
